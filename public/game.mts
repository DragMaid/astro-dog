...
class player extends entity {
    ...
    public constructor(renderer : any, name : string, size : size_t, position: position_t) {
        const p_stats : any = stats['player'];
...
class bullet extends entity {
    ...
    public constructor(renderer : any, id : number, owner : string, size : size_t, position: position_t) {
        const b_stats : any = stats['bullet'];
...
function request_server_update(name : string, score : number, type : string) : void { 
    var destination : string = mainURL + '/' + type;
    var data : any = JSON.stringify({"name": name, "score": score});
    fetch(destination, {
        method: 'POST',
